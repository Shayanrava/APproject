...
static constexpr auto qt_meta_stringdata_CLASSforgetENDCLASS = QtMocHelpers::stringData(
    "forget",
    "readinfo",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSforgetENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSforgetENDCLASS_t qt_meta_stringdata_CLASSforgetENDCLASS = {
    {
        QT_MOC_LITERAL(0, 6),  // "forget"
        QT_MOC_LITERAL(7, 8),  // "readinfo"
        QT_MOC_LITERAL(16, 0)   // ""
    },
    "forget",
    "readinfo",
